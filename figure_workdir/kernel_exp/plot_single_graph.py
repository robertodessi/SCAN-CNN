...
ax2.set_title('JUMP', fontsize=20)
ax2.errorbar(t1, jump_enc_1, jump_std1, label='enc_1', marker='.', color='g', uplims=True, lolims=True)
ax2.errorbar(t2, jump_enc_2, jump_std2, label='enc_2', marker='o', color='b', uplims=True, lolims=True)
ax2.errorbar(t3, jump_enc_3, jump_std3, label='enc_3', marker='x', color='r', uplims=True, lolims=True)
ax2.errorbar(t4, jump_enc_4, jump_std4, label='enc_4', marker='1', color='c', uplims=True, lolims=True)
ax2.errorbar(t5, jump_enc_5, jump_std5, label='enc_5', marker='s', color='m', uplims=True, lolims=True)
...
ax1.errorbar(t1, random_enc_1, random_std1, label='enc_1', marker='.', color='g', uplims=True, lolims=True)
ax1.errorbar(t2, random_enc_2, random_std2, label='enc_2', marker='o', color='b', uplims=True, lolims=True)
ax1.errorbar(t3, random_enc_3, random_std3, label='enc_3', marker='x', color='r', uplims=True, lolims=True)
ax1.errorbar(t4, random_enc_4, random_std4, label='enc_4', marker='1', color='c', uplims=True, lolims=True)
ax1.errorbar(t5, random_enc_5, random_std5, label='enc_5', marker='s', color='m', uplims=True, lolims=True)
...
ax3.set_title('AROUND-RIGHT', fontsize=20)
ax3.errorbar(t1, template_enc_1, template_std1, label='enc_1', marker='.', color='g', uplims=True, lolims=True, barsabove=True)
ax3.errorbar(t2, template_enc_2, template_std2, label='enc_2', marker='o', color='b', uplims=True, lolims=True, barsabove=True)
ax3.errorbar(t3, template_enc_3, template_std3, label='enc_3', marker='x', color='r', uplims=True, lolims=True, barsabove=True)
ax3.errorbar(t4, template_enc_4, template_std4, label='enc_4', marker='1', color='c', uplims=True, lolims=True, barsabove=True)
ax3.errorbar(t5, template_enc_5, template_std5, label='enc_5', marker='s', color='m', uplims=True, lolims=True, barsabove=True, linewidth=2, elinewidth=-1)
