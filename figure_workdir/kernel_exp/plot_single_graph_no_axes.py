...
ax3.errorbar(t1, template_enc_1, template_std1, label='enc_1', marker='.', color='g', uplims=True, lolims=True)
ax3.errorbar(t2, template_enc_2, template_std2, label='enc_2', marker='o', color='b', uplims=True, lolims=True)
ax3.errorbar(t3, template_enc_3, template_std3, label='enc_3', marker='x', color='r', uplims=True, lolims=True)
ax3.errorbar(t4, template_enc_4, template_std4, label='enc_4', marker='1', color='c', uplims=True, lolims=True)
ax3.errorbar(t5, template_enc_5, template_std5, label='enc_5', marker='s', color='m', uplims=True, lolims=True)
