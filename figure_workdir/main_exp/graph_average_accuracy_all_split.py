...
f = plt.figure(figsize=(4,4), frameon=False)
...
plt.errorbar(t, random_acc, random_std, label=r'\textbf{random}', linestyle='None', marker='x', color='r')
plt.errorbar(t, jump_acc, jump_std, label=r'\textbf{jump}', linestyle='None', marker='.', color='g', uplims=True, lolims=True)
plt.errorbar(t, template_acc, template_std, label=r'\textbf{around-right}', linestyle='None', marker='o', color='b', uplims=True, lolims=True)
...
#f.set_figheight(6)
#f.set_figwidth(8)
f.savefig('/Users/robertodessi/Desktop/SCAN-CNN/writeups/acl2019/figures/accuracies_all_splits2.png', format='png', bbox_inches='tight', dpi=200)
